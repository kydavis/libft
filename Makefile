...
#    Updated: 2016/11/04 09:15:34 by kdavis           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME			=	libft.a

SUBDIR			= memory list gnl leftovers type str
...
STR				+=ft_strtrim.c ft_strsplit.c

LEFTOVERS		+=ft_atoi.c 
LEFTOVERS		+=ft_itoa.c ft_putchar.c ft_putstr.c ft_putendl.c
LEFTOVERS		+=ft_putnbr.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c
LEFTOVERS		+=ft_putnbr_fd.c 
